            ...
            <div class="col-md-8 mb-3">
                <div class="osahan-cart-item-profile">
                    ...
                    <div class="box bg-white mb-3 shadow-sm rounded">
                        ...
                        <div class="overflow-hidden border-top d-flex align-items-center p-3">
                            <a class="font-weight-bold d-block" href="#"> Swiggiweb {{trans('lang.safety_center')}}
                                . </a>
                            <i class="feather-arrow-right-circle ml-auto text-primary"></i>
                        </div>
                    </div>
...
<nav id="main-nav">
    <ul class="second-nav">
        ...
        <li><a href="restaurant.html"><i class="feather-paperclip mr-2"></i> {{trans('lang.restaurant_details')}}</a>
        </li>
            ...
            <div class="modal-body">
                <form class="">
                    <div class="form-row">
                        ...
                        <div class="col-md-12 form-group"><label
                                class="form-label">{{trans('lang.delivery_instruction')}}</label><input
