                                ...
                                <table class="payment-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right payment-buttons">
                                            ...
                                            <form action="<?php echo route('wallet-process-mercadopago'); ?>" method="post">
                                                ...
                                                <button
                                                    type="submit">{{trans('lang.pay_$')}}<?php echo $amount; ?></button>
    ...
    function setOutcome(result) {
        ...
        if (result.token) {
            ...
            $.ajax({
                ...
                url: "<?php echo route('wallet-process-mercadopago'); ?>",
