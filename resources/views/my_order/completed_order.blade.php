                                    ...
                                    <div class="card p-3">
                                        ...
                                        <div class="form-group widt-100 gendetail-col">
                                            <div class="bill-address">
                                                ...
                                                <p id="billing_adrs"><strong>{{trans('lang.billing_address')}} :
                                                    </strong><span id="billing_line1"></span><br>
...
<script type="text/javascript">
    ...
    var completedorsersref = database.collection('orders').where('id', "==", orderId);
    ...
    async function getOrderDetails() {
        ...
        completedorsersref.get().then(async function (completedorderSnapshots) {
            ...
            reviewUserName = orderDetails.user.name;
            reviewUserProfile = orderDetails.user.image;
